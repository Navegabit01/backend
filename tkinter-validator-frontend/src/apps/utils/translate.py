class Translate:
    ...
    EXTRA_TEXT = {"es": "TEXTO EXTRA", "en": "EXTRA TEXT"}
    TEXT_TO_TEXT = {"es": "Texto a texto", "en": "Text to text"}
    VOICE_TO_TEXT = {"es": "Voz a texto", "en": "Voice to text"}
    TEXT_TO_VOICE = {"es": "Texto a voz", "en": "Text to voice"}
    VOICE_TO_VOICE = {"es": "Voz a voz", "en": "Voice to voice"}
    TIME_BETWEEN_WORDS = {"es": "TIEMPO DE GRABACION", "en": "RECORD TIME"}
    OPENAI_KEY = {"es": "LLAVE DE CHATGPT", "en": "CHATGPT KEY"}
    BARD_KEY = {"es": "LLAVE DE BARD", "en": "BARD KEY"}
    CLAUDE_KEY = {"es": "LLAVE DE CLAUDE", "en": "CLAUDE KEY"}
    LANG = {"es": ["Espanol", "Ingles"], "en": ["English", "Spanish"]}


Translations = {
    "title": {"Español": "Configuración de Ambit", "English": "Ambit Configuration"},
    ...
    "file_extensions_placeholder": {
        "Español": "Extensiones de fichero",
    ...
    "set_hotkey_1": {"Español": "Establecer Hotkey 1", "English": "Set Hotkey 1"},
    "set_hotkey_2": {"Español": "Establecer Hotkey 2", "English": "Set Hotkey 2"},
    "hotkey_1_default": {
    ...
    "HotKey_title_text": {"Español": "Insertar de Teclas", "English": "Set Hotkey"},
}
...
class Translations2:
    def __init__(self):
        ...
        self.translations = {
            "title": {
                "Español": "Configuración de Ambit",
            ...
            "set_hotkey_1": {
                "Español": "Establecer Hotkey 1",
                "English": "Set Hotkey 1",
            },
            "set_hotkey_2": {
                "Español": "Establecer Hotkey 2",
    ...
    def get_current_in_out_selector(self):
        pass

        # temp = self.lang.get_value("in_out_selector")[self.in_out_selector_pos]
